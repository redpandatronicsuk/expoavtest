    ...
    this.soundObj = await Audio.Sound.createAsync(
      ...
      ps => {
        MusicControl.updatePlayback({
          state: this.state.isAudioPlaying ? MusicControl.STATE_PLAYING : MusicControl.STATE_PAUSED, // (STATE_ERROR, STATE_STOPPED, STATE_PLAYING, STATE_PAUSED, STATE_BUFFERING)
          speed: 1, // Playback Rate
          elapsedTime: (ps.positionMillis || 0) * .001 // (Seconds)
        })
      }
    )
